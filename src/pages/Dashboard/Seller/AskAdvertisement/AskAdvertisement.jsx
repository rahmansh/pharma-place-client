                                    ...
                                    <tr key={medicine._id}>
                                        ...
                                        <td>
                                            ...
                                            >
                                                ...
                                                <option disabled={medicine.sliderStatus === "requested"} value="requested">{medicine.sliderStatus === "requested" ? "Requested" : medicine.sliderStatus === "accepted" ? "Accepted" : "Request For Advertisement"}</option>
                                            </select>
                                        </td>
